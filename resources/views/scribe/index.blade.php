    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-v1-products">Get All Products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-POSTapi-v1-products">
                                <a href="#products-POSTapi-v1-products">Add Products to the Database</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-GETapi-v1-products--id-">
                                <a href="#products-GETapi-v1-products--id-">Get a Single Product</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-PUTapi-v1-products--id-">
                                <a href="#products-PUTapi-v1-products--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-DELETEapi-v1-products--id-">
                                <a href="#products-DELETEapi-v1-products--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing Products</p>
                                ...
                                <h2 id="products-GETapi-v1-products">Get All Products</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint is used to fetch all products available in the database.</p>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/products?page=1" \
...
<span id="example-responses-GETapi-v1-products">
            <blockquote>
            <p>Example response (200, Get All Products):</p>
        </blockquote>
                <pre>
...
<i>optional</i> &nbsp;
               ...
               name="page"                data-endpoint="GETapi-v1-products"
               value="1"
               data-component="query">
    <br>
<p>The page number from pagination. Defaut is '1' Example: <code>1</code></p>
            </div>
                </form>

                    <h2 id="products-POSTapi-v1-products">Add Products to the Database</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint is used to add a product to the database.</p>
...
<span id="example-responses-POSTapi-v1-products">
            <blockquote>
            <p>Example response (201, Add a Product):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Et assumenda corrupti est fugiat aut quis."
               data-component="body">
    <br>
<p>Example: <code>Et assumenda corrupti est fugiat aut quis.</code></p>
        </div>
        </form>

                    <h2 id="products-GETapi-v1-products--id-">Get a Single Product</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint is used to return a single products from the database.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/products/15" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/products/15"
);
...
url = 'http://localhost/api/v1/products/15'
headers = {
  'Authorization': 'Bearer &amp;lt;token&amp;gt;',
  'Content-Type': 'application/json',
  'Accept': 'application/json'
...
<span id="example-responses-GETapi-v1-products--id-">
            <blockquote>
            <p>Example response (200, Get a Single Product):</p>
        </blockquote>
                <pre>
...
<p>The ID of the product. Example: <code>15</code></p>
                    ...
                    <h2 id="products-PUTapi-v1-products--id-">Update the specified resource in storage.</h2>
...
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="products-DELETEapi-v1-products--id-">Remove the specified resource from storage.</h2>
